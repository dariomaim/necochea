 ...
 * @return array
 */
function necochea_body_classes( $classes ) {
...
add_filter( 'body_class', 'necochea_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function necochea_pingback_header() {
	if ( is_singular() && pings_open() ) {
		echo '<link rel="pingback" href="', esc_url( get_bloginfo( 'pingback_url' ) ), '">';
	}
}
add_action( 'wp_head', 'necochea_pingback_header' );
 ...
 * @return String
 */
function necochea_post_type_discovery() {
	if (
			has_post_thumbnail() &&
			get_the_title() === ""
	) {
...
function necochea_archive_title( $title ) {
...
add_filter( 'get_the_archive_title', 'necochea_archive_title' );
