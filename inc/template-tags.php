...
if ( ! function_exists( 'necochea_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function necochea_posted_on() {
...
if ( ! function_exists( 'necochea_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function necochea_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'necochea_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function necochea_entry_footer() {
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'necochea' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'necochea_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function necochea_post_thumbnail() {
